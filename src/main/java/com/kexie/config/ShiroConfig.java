...
import com.kexie.security.WebLoginShiroRealm;
...
//        hashedCredentialsMatcher.setHashIterations(1);//散列的次数，比如散列两次，相当于 md5(md5(""));
    ...
    @Bean
    public WebLoginShiroRealm myShiroRealm(EhCacheManager ehCacheManager) {
        WebLoginShiroRealm myShiroRealm = new WebLoginShiroRealm();
